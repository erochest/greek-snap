...
DOM.addEvent = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["unknown"],window['addEventListener'](Fay$$fayToJs_string($p1),Fay$$fayToJs(["action",[["unknown"]]],$p2))));
    });
  };
};
...
DOM.createElement = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay(["user","Element",[]],window['document']['createElement'](Fay$$fayToJs_string($p1))));
  });
};
...
DOM.setInterval = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","Timer",[]],(function (f,i) { var id = window['setInterval'](function () { f(id); }, i); })(Fay$$fayToJs(["function",[["user","Timer",[]],["action",[["unknown"]]]]],$p2),Fay$$fayToJs_double($p1))));
    });
  };
};
...
DOM.setTimeout = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","Timer",[]],window['setTimeout'](Fay$$fayToJs(["function",[["user","Timer",[]],["action",[["unknown"]]]]],$p2),Fay$$fayToJs_double($p1))));
    });
  };
};
...
DOM.open = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
        return new Fay$$Monad(Fay$$jsToFay(["user","XMLHttpRequest",[]],(function(method, url, xhr) { xhr['open'](method['instance'], url, true); return xhr; })(Fay$$fayToJs(["user","RequestMethod",[]],$p1), Fay$$fayToJs_string($p2), Fay$$fayToJs(["user","XMLHttpRequest",[]],$p3))));
      });
    };
  };
};
...
DOM.responseText = function($p1){
  return new Fay$$$(function(){
    return new Fay$$Monad(Fay$$jsToFay_string(Fay$$fayToJs(["user","XMLHttpRequest",[]],$p1)['responseText']));
  });
};
...
JQuery.selectInContext = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay(["user","JQuery",[]],jQuery(Fay$$fayToJs(["unknown"],$p1), Fay$$fayToJs(["unknown"],$p2))));
    });
  };
};
...
JQuery.is = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      return new Fay$$Monad(Fay$$jsToFay_bool(Fay$$fayToJs(["user","JQuery",[]],$p2)['is'](Fay$$fayToJs(["unknown"],$p1))));
    });
  };
};
...
var Split = {};
Split.hideAll = function($p1){
  return new Fay$$$(function(){
    var spd = $p1;
    return Fay$$_(Prelude.mapM_)(Fay$$_(JQuery.hide)(spd));
  });
};
Split.mapM = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      if (Fay$$_($p2) === null) {
        return Fay$$_(Fay$$$_return)(null);
      }
      var $tmp1 = Fay$$_($p2);
      if ($tmp1 instanceof Fay$$Cons) {
        var x = $tmp1.car;
        var xs = $tmp1.cdr;
        var f = $p1;
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(f)(x)))(function($p1){
          var y = $p1;
          return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(Fay$$_(Split.mapM)(f))(xs)))(function($p1){
            var ys = $p1;
            return Fay$$_(Fay$$_(Prelude.$36$)(Fay$$$_return))(Fay$$_(Fay$$_(Fay$$cons)(y))(ys));
          });
        });
      }
      throw ["unhandled case in mapM",[$p1,$p2]];
    });
  };
};
Split.doPage = function($p1){
  return function($p2){
    return new Fay$$$(function(){
      var rest = $p2;
      var current = $p1;
      if (Fay$$listLen(Fay$$_($p1),2)) {
        var subtitle = Fay$$index(0,Fay$$_($p1));
        var elid = Fay$$index(1,Fay$$_($p1));
        return Fay$$_(Fay$$_(Fay$$bind)(Fay$$_(JQuery.select)(elid)))(function($p1){
          var current$39$ = $p1;
          return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Prelude.$61$$60$$60$)(Fay$$_(JQuery.setText)(subtitle)))(Fay$$_(JQuery.select)("#subtitle"))))(Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Prelude.$61$$60$$60$)(Fay$$_(Fay$$_(Split.setProgress)(Fay$$_(Fay$$_(Fay$$sub)(2))(Fay$$_(Prelude.length)(rest))))(3)))(Fay$$_(JQuery.select)(".progress-bar"))))(Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(JQuery.jshow)(JQuery.Slow))(current$39$)))((function($tmp1){
            var $tmp2 = Fay$$_($tmp1);
            if ($tmp2 instanceof Fay$$Cons) {
              var next = $tmp2.car;
      ...
      throw ["unhandled case in doPage",[$p1,$p2]];
    });
  };
};
Split.setProgress = function($p1){
  return function($p2){
    return function($p3){
      return new Fay$$$(function(){
        var progressBar = $p3;
        ...
        var valueNow = $p1;
        return (function(){
          var width = new Fay$$$(function(){
            return Fay$$_(Fay$$_(Prelude.$36$)(Prelude.truncate))(Fay$$_(Fay$$_(Fay$$divi)(Fay$$_(Fay$$_(Fay$$mult)(100))(Fay$$_(Prelude.fromIntegral)(valueNow))))(Fay$$_(Prelude.fromIntegral)(valueMax)));
          });
          return Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Fay$$_(JQuery.setAttr)("aria-valuenow"))(Fay$$_(Split.showt)(valueNow)))(progressBar)))(Fay$$_(Fay$$_(Fay$$then)(Fay$$_(Fay$$_(Fay$$_(JQuery.setAttr)("style"))(Fay$$_(Fay.Text.concat)(Fay$$list(["width: ",Fay$$_(Split.showt)(width),"%;"]))))(progressBar)))(Fay$$_(Fay$$$_return)(Fay$$unit)));
        })();
      });
    };
  };
